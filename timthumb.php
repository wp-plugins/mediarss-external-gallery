<?php
/**
 * TimThumb (16 Set. 2011) by Ben Gillbanks and Mark Maunder
...
$ALLOWED_SITES_FILE = 'allowedsites.json';
$HANDLE = fopen($ALLOWED_SITES_FILE, "rb");
$ALLOWED_SITES = json_decode(fread($HANDLE,filesize($ALLOWED_SITES_FILE)));
fclose($HANDLE);
